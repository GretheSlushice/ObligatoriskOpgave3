...
press.addEventListener("click", display);
function display() {
    var inputField = document.getElementById("input");
    var transformSelection = document.getElementById("select");
    var result = inputField.value;
    if (transformSelection.value == "Upper case") {
        outputField.innerHTML = result.toUpperCase();
    }
    else {
        outputField.innerHTML = result.toLowerCase();
    }
}
